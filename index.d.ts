declare module "react-native-powerauth" {
    ...
    export function validatePasswordCorrect(oldPassword: string): Promise<string>;

    export function unsafeChangePassword(oldPassword: string, newPassword: string): Promise<string>;
}